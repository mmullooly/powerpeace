...
const images = [
	`${base}assets/IMG_7784.webp`,
	`${base}assets/IMG_7787.webp`,
	`${base}assets/Screenshot_133012.webp`,
	`${base}assets/IMG_9002.webp`,
	`${base}assets/Screenshot_131924.webp`
    ];
					...
					<div className="playtestsGrid">
						<article className="playtestsCard">
							<div className="playtestsImgPlaceholder">
                                <img src={`${base}assets/IMG_7701.webp`} alt="image of game in action" loading="lazy"/>
                            </div>
						...
						<article className="playtestsCard">
							<div className="playtestsImgPlaceholder">
                                <img src={`${base}assets/9007.webp`} alt="image of game in action" loading="lazy"/>
                            </div>
							<div className="playtestsCardBody">
								<div className="playtestsCardHeaderBar">
						...
						<article className="playtestsCard">
							<div className="playtestsImgPlaceholder">
                                <img src={`${base}assets/3656.webp`} alt="image of game in action" loading="lazy"/>
                            </div>
							<div className="playtestsCardBody">
								<div className="playtestsCardHeaderBar">
