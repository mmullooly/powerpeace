...
export default function About(){
	...
	const gallery = [
		{ src: `${base}assets/Screenshot_134135.webp`, alt: "Working in our old studio" },
		{ src: `${base}assets/7482.webp`, alt: "Design demo prototype" },
		{ src: `${base}assets/drawing.webp`, alt: "Early prototype materials and layout" },
		{ src: `${base}assets/7409.webp`, alt: "Iteration notes and balance adjustments" },
		{ src: `${base}assets/demo.webp`, alt: "Design sketches and systems planning" },
		{ src: `${base}assets/presentation.webp`, alt: "Founder presenting the game concept" },
	];
				...
				<div className="about__wrap about__heroGrid">
					...
					<figure className="about__heroMedia">
						<img
							...
							src={`${import.meta.env.BASE_URL}assets/p1.webp`}
				...
				<div className="about__wrap about__founderGrid">
					<figure className="about__founderMedia">
						<img
							...
							src={`${import.meta.env.BASE_URL}assets/IMG_7786.webp`}
